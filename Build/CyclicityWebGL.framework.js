...
function _BrowserTextUpload(extFilter, gameObjName, dataSinkFn) {
 if (typeof inputLoader == "undefined") {
  ...
  inputLoader.onchange = function(x) {
   ...
   reader.onload = function(evt) {
    ...
    HexaGame.SendMessage(inputLoader.gameObjName, inputLoader.dataSinkFn, evt.target.result);
   };
...
var asmLibraryArg = {
 "BrowserTextUpload": _BrowserTextUpload,
